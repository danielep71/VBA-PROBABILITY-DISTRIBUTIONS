...
'   observed_vba in f_envelope_bothlarge_grid.csv for F_Cumulative and F_Survival across a
...
'
' USAGE
'   Run Export_FEnvelopeBothLarge and pick f_envelope_bothlarge_grid.csv in the dialog.
'
' DEPENDENCIES
